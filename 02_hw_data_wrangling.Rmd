...
Number of candidates in the dataset: 7014
...
knitr::kable(party_incumbent_promote, col.names = c("Party Affiliation", "Incumbancy Status", "Proportion of Self-Promotion"))
```

On average, incumbent democrats sponsored the most promoting ads, with approximately 85.4% of ads falling into that category. 
...
The histogram is positively skewed, meaning the majority of the House candidates had less than 10 million ads impressions on Facebook, with only the tail end passing the 10 million marker in the visual.
...
fb_top_plot <- fb_ads |>
  ...
  labs(x = "Estimated Total Impressions of Facebook Ads by the Millions",
       y = "US House Candidates")
fb_top_plot
```
